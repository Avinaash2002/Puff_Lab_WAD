        ...
        <nav>
            <ul>
                ...
                <li class="logo-container">
                    <a href="Admin_Login.php"><div class="logo"></div></a>
                </li>
...
if(isset($_POST['Login']))
{
    ...
    $result = mysqli_query($conn, "SELECT * FROM admin where username='$Admin_username'");
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        echo "<script>
                ...
                icon: 'error',
                title: 'Oops...',
                text: 'Unautorised excess. Admin not Registered',
                });
            </script>";
